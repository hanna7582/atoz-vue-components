...
import BarChart1 from '@/components/amChart/bar/BarChart1.vue'
import BarChart2 from '@/components/amChart/bar/BarChart2.vue'
import BarChart3 from '@/components/amChart/bar/BarChart3.vue'

//Markdown
import BarChart1Md from '@/md/amChart/bar/BarChart1.md'
import BarChart2Md from '@/md/amChart/bar/BarChart2.md'
import BarChart3Md from '@/md/amChart/bar/BarChart3.md'

//data
import ChartData from '@/data/amChart/BarChart'
...
export default {
  ...
  computed: {
    category() {
      ...
      category = _.find(category.depth3, { name: 'barChart' }).depth4
      return category
    }
  },
  methods: {
