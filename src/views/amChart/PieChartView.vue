...
import PieChart1 from '@/components/amChart/pie/PieChart1.vue'

//Markdown
import PieChart1Md from '@/md/amChart/pie/PieChart1.md'

//data
import ChartData from '@/data/amChart/PieChart'
...
export default {
  ...
  data() {
    return {
      currentComp: 'PieChart1',
      currentDesc: 'PieChart1Md',
      currentData: ChartData['PieChart1'],
      initData: ChartData['PieChart1'],
      height: {
        PieChart1: '350px'
      }
    }
  ...
  computed: {
    category() {
      ...
      category = _.find(category.depth3, { name: 'pieChart' }).depth4
      return category
    }
  },
  methods: {
